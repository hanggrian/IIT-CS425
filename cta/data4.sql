-- Stations: https://www.transitchicago.com/assets/1/6/ctamap_Lsystem.png
-- Alerts:
-- - Rails: https://www.transitchicago.com/travel-information/railstatus/
-- - Elevators: https://www.transitchicago.com/alerts/elevators/
-- Conductors: https://en.wikipedia.org/wiki/List_of_South_Park_characters
-- Passengers: https://en.wikipedia.org/wiki/List_of_Futurama_characters
...
INSERT INTO Conductors VALUES
  ('marsh1', DEFAULT, 'Stan Marsh', '2001-02-21', '1992-10-19', 2023 - 1992, '202-555-0148'),
  ('broflovski1', DEFAULT, 'Kyle Broflovski', '2002-04-12', '1992-05-26', 2023 - 1992, '202-555-0104,202-555-0168'),
  ('cartman1', DEFAULT, 'Eric Cartman', '2013-04-14', '1992-04-13', 2023 - 1992, '202-555-0171'),
  ('mccormick1', DEFAULT, 'Kenny McCormick', '2014-02-21', '1992-04-22', 2023 - 1992, '202-555-0174,202-555-0103'),
  ('stotch1', DEFAULT, 'Butters Stotch', '2020-07-14', '1997-08-13', 2023 - 1997, '202-555-0178'),
  ('marsh2', DEFAULT, 'Randy Marsh', '2014-02-27', '1997-01-01', 2023 - 1997, '202-555-0199,202-555-0166'),
  ('garrison1', DEFAULT, 'Herbert Garrison', '2013-07-12', '1997-01-01', 2023 - 1997, '202-555-0178'),
  ('mackey1', DEFAULT, 'Mr. Mackey', '2009-02-15', '1997-01-01', 2023 - 1997, '202-555-0166'),
  ('broflovski2', DEFAULT, 'Gerald Broflovski', '2013-09-30', '1997-01-01', 2023 - 1997, '202-555-0148'),
  ('broflovski3', DEFAULT, 'Sheila Broflovski', '2017-06-03', '1997-01-01', 2023 - 1997, '202-555-0185'),
  ('cartman2', DEFAULT, 'Liane Cartman', '2004-11-09', '1997-01-01', 2023 - 1997, '202-555-0178,202-555-0166'),
  ('valmer1', DEFAULT, 'Jimmy Valmer', '2006-03-27', '2001-01-01', 2023 - 2001, '202-555-0166'),
  ('black1', DEFAULT, 'Tolkien Black', '2013-06-24', '1997-01-01', 2023 - 1997, '202-555-0199'),
  ('testaburger1', DEFAULT, 'Wendy Testaburger', '2006-10-10', '1995-01-01', 2023 - 1995, '202-555-0166'),
  ('donovan1', DEFAULT, 'Clyde Donovan', '2000-09-17', '1997-01-01', 2023 - 1997, '202-555-0185,202-555-0178'),
  ('tucker1', DEFAULT, 'Craig Tucker', '2006-02-06', '1997-01-01', 2023 - 1997, '202-555-0114'),
  ('stevens1', DEFAULT, 'Bebe Stevens', '2016-10-17', '1994-01-01', 2023 - 1994, '202-555-0163'),
  ('turner1', DEFAULT, 'Heidi Turner', '2009-12-08', '1994-01-01', 2023 - 1994, '202-555-0178'),
  ('malkinson1', DEFAULT, 'Scott Malkinson', '2002-07-16', '1994-01-01', 2023 - 1994, '202-555-0161'),
  ('burch1', DEFAULT, 'Timmy Burch', '2011-03-28', '1994-01-01', 2023 - 1994, '202-555-0192'),
  ('tweak1', DEFAULT, 'Tweek Tweak', '2021-09-04', '1994-01-01', 2023 - 1994, '202-555-0199'),
  ('principal1', DEFAULT, 'PC Principal', '2009-05-31', '1994-01-01', 2023 - 1994, ''),
  ('woman1', DEFAULT, 'Strong Woman', '2006-07-23', '1994-01-01', 2023 - 1994, '202-555-0185'),
  ('marsh3', DEFAULT, 'Sharon Marsh', '2015-03-05', '1994-01-01', 2023 - 1994, '202-555-0114'),
  ('marsh4', DEFAULT, 'Shelley Marsh', '2006-02-21', '1994-01-01', 2023 - 1994, '202-555-0166');
...
INSERT INTO Passengers VALUES
  (1, 'Philip J. Fry', '2004-02-21'),
  (2, 'Turanga Leela', '2001-12-20'),
  (3, 'Bender Bending Rodriguez', '2010-02-01'),
  (4, 'Hubert J. Farnsworth', '2020-11-06'),
  (5, 'John Zoidberg', '2021-06-12'),
  (6, 'Amy Wong', '2001-05-21'),
  (7, 'Hermes Conrad', '2005-03-04'),
  (8, 'Nibbler', '2004-07-20'),
  (9, 'Zapp Brannigan', '2003-06-11'),
  (10, 'Kif Kroker', '2023-05-18'),
  (11, 'Mom', '2021-02-17'),
  (12, 'Headless Body of Agnew', '2019-12-06'),
  (13, 'Boxy', '2015-10-03'),
  (14, 'Brain Slugs', '2012-12-21'),
  (15, 'Brain Spawn', '2003-02-19'),
  (16, 'Calculon', '2001-06-07'),
  (17, 'Antonio Calculon', '2004-10-19'),
  (18, 'The Crushinator', '2013-12-21'),
  (19, 'Father Changstein-El-Gamal', '2014-04-27'),
  (20, 'Chanukah Zombie', '2009-02-07'),
  (21, 'Clamps', '2003-06-11'),
  (22, 'Dwight Conrad', '2001-01-23'),
  (23, 'LaBarbara Conrad', '2008-03-28'),
  (24, 'Donbot', '2011-02-08'),
  (25, 'Abner Doubledeal', '2021-04-01');
...
INSERT INTO Trips VALUES
  ('2020-01-04', 1, 2.5, 1, 'Red', 'Howard', 'Belmont'),
  ('2020-02-12', 2, 2.0, 2, 'Brown', 'Belmont', 'Paulina'),
  ('2021-01-23', 3, 3.0, NULL, 'Purple', 'Linden', 'Foster'),
  ('2021-02-12', 4, 2.0, 4, 'Brown', 'Kimball', 'Belmont'),
  ('2021-04-17', 5, 5.0, 5, 'Blue', "O'Hare", 'Irving Park'),
  ('2021-04-29', 6, 3.5, NULL, 'Blue', 'LaSalle', 'Clark-Lake'),
  ('2021-06-27', 7, 2.0, 7, 'Blue', 'LaSalle', 'Irving Park'),
  ('2021-08-27', 8, 3.5, 8, 'Green', 'Clark-Lake', 'Roosevelt'),
  ('2021-09-21', 9, 4.0, 9, 'Green', 'Ashland/63rd', 'Roosevelt'),
  ('2021-11-28', 10, 4.5, 10, 'Orange', 'Midway', 'Halsted'),
  ('2021-11-02', 11, 3.0, NULL, 'Orange', 'Roosevelt', 'Halsted'),
  ('2022-02-06', 12, 2.5, 12, 'Red', 'Belmont', 'Garfield'),
  ('2022-04-27', 13, 3.5, 13, 'Pink', 'Polk', 'Pulaski'),
  ('2022-05-08', 14, 5.0, 14, 'Pink', 'LaSalle', 'Pulaski'),
  ('2022-05-19', 15, 2.5, NULL, 'Pink', 'Pulaski', 'Polk'),
  ('2022-06-21', 16, 3.0, 16, 'Yellow', 'Dempster-Skokie', 'Howard'),
  ('2022-09-05', 17, 2.5, 17, 'Yellow', 'Howard', 'Dempster-Skokie'),
  ('2022-10-01', 18, 4.0, 18, 'Brown', 'Paulina', 'Kimball'),
  ('2022-10-23', 19, 3.5, 19, 'Red', 'Sheridan', 'Garfield'),
  ('2022-12-11', 20, 2.0, NULL, 'Green', 'Roosevelt', 'Clark-Lake'),
  (DEFAULT, 21, 2.5, NULL, 'Blue', "O'Hare", 'Clark-Lake'),
  (DEFAULT, 22, 2.0, 22, 'Blue', 'Irving Park', 'Clark-Lake'),
  (DEFAULT, 23, 4.0, 23, 'Green', 'Roosevelt', 'Ashland/63rd'),
  (DEFAULT, 24, 3.0, NULL, 'Purple', 'Linden', 'Howard'),
  (DEFAULT, 25, 5.0, 25, 'Purple', 'Howard', 'Foster');
